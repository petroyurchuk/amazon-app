...
import { selectProducts, selectProductsNumber } from "../redux/cart/selectors";
import {
  removeFromCart,
  decrementInCart,
  incrementInCart,
...
const Checkout = () => {
  ...
  const itemsNumber = useSelector(selectProductsNumber);
  const dispatch = useDispatch();
  const subtotal = calcTotalPrice(products);
  return (
